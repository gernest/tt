...
type Rule_HTTP_Methods struct {
	...
	Method Rule_HTTP_Method `protobuf:"varint,1,opt,name=method,proto3,enum=Rule_HTTP_Method" json:"method,omitempty"`
}
...
var file_tcp_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x52, 0x75, 0x6c, 0x65, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x2e,
