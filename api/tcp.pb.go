...
var file_tcp_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x74, 0x42, 0x04, 0x0a, 0x02, 0x74, 0x6f, 0x22, 0xc0, 0x06, 0x0a, 0x05, 0x52, 0x6f,
	...
	0x12, 0x25, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18, 0x11, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x09, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x52, 0x08, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x1a, 0x40, 0x0a, 0x12, 0x4d, 0x65, 0x74, 0x72, 0x69,
...
var file_tcp_proto_depIdxs = []int32{
	...
	7,  // 9: Route.load_balance:type_name -> WeightedAddr
	1,  // 10: Route.load_balance_algo:type_name -> Route.LoadBalanceAlgo
	12, // 11: Route.speed:type_name -> Speed
	17, // 12: Route.rule:type_name -> Rule
	9,  // 13: Route.middlewares:type_name -> Middleware
	0,  // 14: Route.protocol:type_name -> Protocol
	14, // 15: Retries.budget:type_name -> RetryBudget
	31, // 16: RetryBudget.ttl:type_name -> google.protobuf.Duration
	32, // 17: RequestMatch.fixed:type_name -> google.protobuf.Empty
	0,  // 18: Context.protocol:type_name -> Protocol
	21, // 19: Context.downstream:type_name -> Context.Conn
	21, // 20: Context.upstream:type_name -> Context.Conn
	22, // 21: Context.info:type_name -> Context.Info
	23, // 22: Rule.all:type_name -> Rule.List
	23, // 23: Rule.any:type_name -> Rule.List
	17, // 24: Rule.not:type_name -> Rule
	24, // 25: Rule.tcp:type_name -> Rule.TCP
	25, // 26: Rule.http:type_name -> Rule.HTTP
	20, // 27: Context.Conn.stat:type_name -> Context.Stat
	33, // 28: Context.Info.sni:type_name -> google.protobuf.StringValue
	33, // 29: Context.Info.host:type_name -> google.protobuf.StringValue
	33, // 30: Context.Info.path:type_name -> google.protobuf.StringValue
	17, // 31: Rule.List.rules:type_name -> Rule
	28, // 32: Rule.TCP.ports:type_name -> Rule.TCP.PortRange
	29, // 33: Rule.HTTP.methods:type_name -> Rule.HTTP.Methods
	27, // 34: Rule.HTTP.path:type_name -> Rule.StringMatch
	30, // 35: Rule.HTTP.headers:type_name -> Rule.HTTP.Headers
	27, // 36: Rule.Header.value:type_name -> Rule.StringMatch
	2,  // 37: Rule.HTTP.Methods.methods:type_name -> Rule.HTTP.Method
	26, // 38: Rule.HTTP.Headers.headers:type_name -> Rule.Header
	3,  // 39: Proxy.Get:input_type -> ConfigRequest
	6,  // 40: Proxy.Put:input_type -> Config
	6,  // 41: Proxy.Post:input_type -> Config
	4,  // 42: Proxy.Delete:input_type -> DeleteRequest
	6,  // 43: Proxy.Get:output_type -> Config
	5,  // 44: Proxy.Put:output_type -> Response
	5,  // 45: Proxy.Post:output_type -> Response
	5,  // 46: Proxy.Delete:output_type -> Response
