...
var file_tcp_proto_rawDesc = []byte{
	...
	0x54, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x51, 0x55, 0x49, 0x43, 0x10, 0x04, 0x22, 0xa5, 0x07,
	...
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x32, 0x28, 0x0a, 0x05, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x12, 0x1f,
	0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x12, 0x07, 0x2e, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x1a, 0x09, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_tcp_proto_depIdxs = []int32{
	...
	27, // 14: RetryBudget.ttl:type_name -> google.protobuf.Duration
	28, // 15: RequestMatch.fixed:type_name -> google.protobuf.Empty
	...
	29, // 26: Context.Info.sni:type_name -> google.protobuf.StringValue
	29, // 27: Context.Info.host:type_name -> google.protobuf.StringValue
	29, // 28: Context.Info.path:type_name -> google.protobuf.StringValue
	13, // 29: Rule.List.rules:type_name -> Rule
	24, // 30: Rule.TCP.ports:type_name -> Rule.TCP.PortRange
	25, // 31: Rule.HTTP.methods:type_name -> Rule.HTTP.Methods
	23, // 32: Rule.HTTP.path:type_name -> Rule.StringMatch
	26, // 33: Rule.HTTP.headers:type_name -> Rule.HTTP.Headers
	23, // 34: Rule.Header.vallue:type_name -> Rule.StringMatch
	2,  // 35: Rule.HTTP.Methods.methods:type_name -> Rule.HTTP.Method
	22, // 36: Rule.HTTP.Headers.headers:type_name -> Rule.Header
	4,  // 37: Proxy.Configure:input_type -> Config
	3,  // 38: Proxy.Configure:output_type -> Response
