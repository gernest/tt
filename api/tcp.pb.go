...
type Rule_HTTP_Methods struct {
	...
	Method []Rule_HTTP_Method `protobuf:"varint,1,rep,packed,name=method,proto3,enum=Rule_HTTP_Method" json:"method,omitempty"`
}
...
func (x *Rule_HTTP_Methods) GetMethod() []Rule_HTTP_Method {
	if x != nil {
		return x.Method
	}
	return nil
...
var file_tcp_proto_rawDesc = []byte{
	...
	0x54, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x51, 0x55, 0x49, 0x43, 0x10, 0x04, 0x22, 0xf9, 0x05,
	...
	0x1a, 0xa9, 0x02, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x12, 0x2e, 0x0a, 0x07, 0x6d, 0x65, 0x74,
	...
	0x48, 0x00, 0x52, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x1a, 0x34, 0x0a, 0x07, 0x4d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x73, 0x12, 0x29, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x52, 0x75, 0x6c, 0x65, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x2e,
	0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x52, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0x73,
	...
	0x4c, 0x10, 0x09, 0x42, 0x07, 0x0a, 0x05, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x1a, 0x62, 0x0a, 0x0b,
	...
	0x42, 0x07, 0x0a, 0x05, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x32, 0x28, 0x0a, 0x05, 0x50, 0x72, 0x6f,
	0x78, 0x79, 0x12, 0x1f, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x65, 0x12,
...
var file_tcp_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_tcp_proto_goTypes = []interface{}{
	...
	(*Rule_HTTP_Methods)(nil),    // 24: Rule.HTTP.Methods
...
var file_tcp_proto_depIdxs = []int32{
	...
	25, // 7: Route.timeout:type_name -> google.protobuf.Duration
	25, // 8: Route.keepAlive:type_name -> google.protobuf.Duration
	...
	25, // 14: RetryBudget.ttl:type_name -> google.protobuf.Duration
	26, // 15: RequestMatch.fixed:type_name -> google.protobuf.Empty
	...
	27, // 26: Context.Info.sni:type_name -> google.protobuf.StringValue
	27, // 27: Context.Info.host:type_name -> google.protobuf.StringValue
	27, // 28: Context.Info.path:type_name -> google.protobuf.StringValue
	13, // 29: Rule.List.rules:type_name -> Rule
	23, // 30: Rule.TCP.ports:type_name -> Rule.TCP.PortRange
	24, // 31: Rule.HTTP.methods:type_name -> Rule.HTTP.Methods
	22, // 32: Rule.HTTP.path:type_name -> Rule.StringMatch
	2,  // 33: Rule.HTTP.Methods.method:type_name -> Rule.HTTP.Method
	4,  // 34: Proxy.Configure:input_type -> Config
	3,  // 35: Proxy.Configure:output_type -> Response
