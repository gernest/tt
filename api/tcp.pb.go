...
type Raft_Action int32

const (
	Raft_GET    Raft_Action = 0
	Raft_SET    Raft_Action = 1
	Raft_PUT    Raft_Action = 2
	Raft_POST   Raft_Action = 3
	Raft_DELETE Raft_Action = 4
)

// Enum value maps for Raft_Action.
var (
	Raft_Action_name = map[int32]string{
		0: "GET",
		1: "SET",
		2: "PUT",
		3: "POST",
	...
	Raft_Action_value = map[string]int32{
		"GET":    0,
		"SET":    1,
		"PUT":    2,
		"POST":   3,
...
func (x Raft_Action) Enum() *Raft_Action {
	p := new(Raft_Action)
	*p = x
	return p
}

func (x Raft_Action) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Raft_Action) Descriptor() protoreflect.EnumDescriptor {
	return file_tcp_proto_enumTypes[1].Descriptor()
}

func (Raft_Action) Type() protoreflect.EnumType {
	return &file_tcp_proto_enumTypes[1]
}

func (x Raft_Action) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Raft_Action.Descriptor instead.
func (Raft_Action) EnumDescriptor() ([]byte, []int) {
...
func (Middleware_Version) EnumDescriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 0}
}
...
func (Rule_HTTP_Method) EnumDescriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 2, 0}
}
...
func (Rule_HTTP_KeyValue_Type) EnumDescriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 2, 1, 0}
}
...
func (Rule_HTTP_Path_Type) EnumDescriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 2, 3, 0}
}
...
type Raft_Data struct {
	...
	//	*Raft_Data_Config
	Item isRaft_Data_Item `protobuf_oneof:"item"`
}

func (x *Raft_Data) Reset() {
	*x = Raft_Data{}
	if protoimpl.UnsafeEnabled {
...
func (x *Raft_Data) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Raft_Data) ProtoMessage() {}

func (x *Raft_Data) ProtoReflect() protoreflect.Message {
	mi := &file_tcp_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Raft_Data.ProtoReflect.Descriptor instead.
func (*Raft_Data) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{2, 0}
}

func (m *Raft_Data) GetItem() isRaft_Data_Item {
	if m != nil {
		return m.Item
	}
	return nil
...
func (x *Raft_Data) GetConfig() *Config {
	if x, ok := x.GetItem().(*Raft_Data_Config); ok {
		return x.Config
	}
	return nil
}

type isRaft_Data_Item interface {
	isRaft_Data_Item()
}

type Raft_Data_Config struct {
	Config *Config `protobuf:"bytes,1,opt,name=config,proto3,oneof"`
}

func (*Raft_Data_Config) isRaft_Data_Item() {}
...
type Raft_Log struct {
	...
	Action Raft_Action `protobuf:"varint,1,opt,name=action,proto3,enum=Raft_Action" json:"action,omitempty"`
	Data   *Raft_Data  `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *Raft_Log) GetAction() Raft_Action {
	if x != nil {
		return x.Action
	}
	return Raft_GET
...
func (x *Raft_Log) GetData() *Raft_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
func (*Middleware_Wasm) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 1}
}
...
func (*Middleware_StripPathPrefix) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 2}
}
...
func (*Middleware_Wasm_Setting) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 1, 0}
}
...
func (*Middleware_Wasm_Config) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 1, 1}
}
...
func (*Middleware_Wasm_Setting_Env) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 1, 0, 0}
}
...
func (*Middleware_Wasm_Setting_DirectoryMap) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{7, 1, 0, 1}
}
...
func (*Rule_TCP_PortRange) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 1, 0}
}
...
func (*Rule_HTTP_KeyValue) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 2, 1}
}
...
func (*Rule_HTTP_KeyValueList) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 2, 2}
}
...
func (*Rule_HTTP_Path) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{15, 2, 3}
}
...
func (*AccessEntry_Response) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{16, 3}
}
...
func (*AccessEntry_Info) Descriptor() ([]byte, []int) {
	return file_tcp_proto_rawDescGZIP(), []int{16, 4}
}
...
var file_tcp_proto_rawDesc = []byte{
	...
	,
	...
	0x54, 0x45, 0x10, 0x04, 0x22, 0x3e, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x73, 0x75, 0x6c, 0x74, 0x22, 0x38, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1e,
	0x0a, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x06,
	0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x06, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x22, 0xcb,
	0x01, 0x0a, 0x0c, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x41, 0x64, 0x64, 0x72, 0x12,
	0x1c, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x22, 0xac, 0x07, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x19, 0x0a, 0x04, 0x62,
	...
	,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x28, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x09, 0x0a,
	0x05, 0x45, 0x78, 0x61, 0x63, 0x74, 0x10, 0x00, 0x12, 0x15, 0x0a, 0x11, 0x52, 0x65, 0x67, 0x75,
	0x6c, 0x61, 0x72, 0x45, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x10, 0x01, 0x1a,
	...
	,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xdc, 0x01, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x41, 0x67,
	...
	,
	...
	0x69, 0x7a, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x1a, 0x6c, 0x0a, 0x0c, 0x52, 0x65, 0x76, 0x65, 0x72,
	0x73, 0x65, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x79, 0x74, 0x65, 0x73,
	0x5f, 0x73, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x62, 0x79, 0x74,
	...
	,
	...
	,
...
var file_tcp_proto_msgTypes = make([]protoimpl.MessageInfo, 45)
var file_tcp_proto_goTypes = []interface{}{
	(Protocol)(0),                                // 0: Protocol
	(Raft_Action)(0),                             // 1: Raft.Action
	...
	(*RaftLog)(nil),                              // 25: RaftLog
	(*Raft_Data)(nil),                            // 26: Raft.Data
	(*Raft_Log)(nil),                             // 27: Raft.Log
	nil,                                          // 28: WeightedAddr.MetricLabelsEntry
	(*Middleware_List)(nil),                      // 29: Middleware.List
	(*Middleware_Wasm)(nil),                      // 30: Middleware.Wasm
	(*Middleware_StripPathPrefix)(nil),           // 31: Middleware.StripPathPrefix
	(*Middleware_Wasm_Setting)(nil),              // 32: Middleware.Wasm.Setting
	(*Middleware_Wasm_Config)(nil),               // 33: Middleware.Wasm.Config
	(*Middleware_Wasm_Setting_Env)(nil),          // 34: Middleware.Wasm.Setting.Env
	(*Middleware_Wasm_Setting_DirectoryMap)(nil), // 35: Middleware.Wasm.Setting.DirectoryMap
	nil,                              // 36: Route.MetricsLabelsEntry
	(*Context_Stat)(nil),             // 37: Context.Stat
	(*Context_Conn)(nil),             // 38: Context.Conn
	(*Context_Info)(nil),             // 39: Context.Info
	(*Rule_List)(nil),                // 40: Rule.List
	(*Rule_TCP)(nil),                 // 41: Rule.TCP
	(*Rule_HTTP)(nil),                // 42: Rule.HTTP
	(*Rule_TCP_PortRange)(nil),       // 43: Rule.TCP.PortRange
	(*Rule_HTTP_MethodList)(nil),     // 44: Rule.HTTP.MethodList
	(*Rule_HTTP_KeyValue)(nil),       // 45: Rule.HTTP.KeyValue
	(*Rule_HTTP_KeyValueList)(nil),   // 46: Rule.HTTP.KeyValueList
	(*Rule_HTTP_Path)(nil),           // 47: Rule.HTTP.Path
	(*AccessEntry_UserAgent)(nil),    // 48: AccessEntry.UserAgent
	(*AccessEntry_Request)(nil),      // 49: AccessEntry.Request
	(*AccessEntry_ReverseProxy)(nil), // 50: AccessEntry.ReverseProxy
	(*AccessEntry_Response)(nil),     // 51: AccessEntry.Response
	(*AccessEntry_Info)(nil),         // 52: AccessEntry.Info
...
var file_tcp_proto_depIdxs = []int32{
	...
	28, // 2: WeightedAddr.metric_labels:type_name -> WeightedAddr.MetricLabelsEntry
	30, // 3: Middleware.wasm:type_name -> Middleware.Wasm
	31, // 4: Middleware.strip_path_prefix:type_name -> Middleware.StripPathPrefix
	16, // 5: Route.bind:type_name -> Bind
	21, // 6: Route.condition:type_name -> RequestMatch
	36, // 7: Route.metrics_labels:type_name -> Route.MetricsLabelsEntry
	19, // 8: Route.retries:type_name -> Retries
	53, // 9: Route.timeout:type_name -> google.protobuf.Duration
	53, // 10: Route.keepAlive:type_name -> google.protobuf.Duration
	...
	29, // 15: Route.middlewares:type_name -> Middleware.List
	0,  // 16: Route.protocol:type_name -> Protocol
	20, // 17: Retries.budget:type_name -> RetryBudget
	53, // 18: RetryBudget.ttl:type_name -> google.protobuf.Duration
	54, // 19: RequestMatch.fixed:type_name -> google.protobuf.Empty
	0,  // 20: Context.protocol:type_name -> Protocol
	38, // 21: Context.downstream:type_name -> Context.Conn
	38, // 22: Context.upstream:type_name -> Context.Conn
	39, // 23: Context.info:type_name -> Context.Info
	40, // 24: Rule.all:type_name -> Rule.List
	40, // 25: Rule.any:type_name -> Rule.List
	23, // 26: Rule.not:type_name -> Rule
	41, // 27: Rule.tcp:type_name -> Rule.TCP
	42, // 28: Rule.http:type_name -> Rule.HTTP
	49, // 29: AccessEntry.request:type_name -> AccessEntry.Request
	51, // 30: AccessEntry.response:type_name -> AccessEntry.Response
	50, // 31: AccessEntry.reverse_proxy:type_name -> AccessEntry.ReverseProxy
	52, // 32: AccessEntry.info:type_name -> AccessEntry.Info
	53, // 33: AccessEntry.duration:type_name -> google.protobuf.Duration
	7,  // 34: RaftLog.op:type_name -> RaftLog.OP
	12, // 35: Raft.Data.config:type_name -> Config
	1,  // 36: Raft.Log.action:type_name -> Raft.Action
	26, // 37: Raft.Log.data:type_name -> Raft.Data
	15, // 38: Middleware.List.list:type_name -> Middleware
	33, // 39: Middleware.Wasm.config:type_name -> Middleware.Wasm.Config
	2,  // 40: Middleware.Wasm.version:type_name -> Middleware.Version
	34, // 41: Middleware.Wasm.Setting.environments:type_name -> Middleware.Wasm.Setting.Env
	35, // 42: Middleware.Wasm.Setting.map_directories:type_name -> Middleware.Wasm.Setting.DirectoryMap
	32, // 43: Middleware.Wasm.Config.instance:type_name -> Middleware.Wasm.Setting
	55, // 44: Middleware.Wasm.Config.plugin:type_name -> google.protobuf.Struct
	37, // 45: Context.Conn.stat:type_name -> Context.Stat
	56, // 46: Context.Info.sni:type_name -> google.protobuf.StringValue
	56, // 47: Context.Info.path:type_name -> google.protobuf.StringValue
	23, // 48: Rule.List.rules:type_name -> Rule
	43, // 49: Rule.TCP.ports:type_name -> Rule.TCP.PortRange
	44, // 50: Rule.HTTP.methods:type_name -> Rule.HTTP.MethodList
	47, // 51: Rule.HTTP.path:type_name -> Rule.HTTP.Path
	46, // 52: Rule.HTTP.headers:type_name -> Rule.HTTP.KeyValueList
	46, // 53: Rule.HTTP.query_param:type_name -> Rule.HTTP.KeyValueList
	4,  // 54: Rule.HTTP.MethodList.list:type_name -> Rule.HTTP.Method
	5,  // 55: Rule.HTTP.KeyValue.type:type_name -> Rule.HTTP.KeyValue.Type
	45, // 56: Rule.HTTP.KeyValueList.list:type_name -> Rule.HTTP.KeyValue
	6,  // 57: Rule.HTTP.Path.type:type_name -> Rule.HTTP.Path.Type
	48, // 58: AccessEntry.Request.user_agent:type_name -> AccessEntry.UserAgent
	53, // 59: AccessEntry.Response.time_to_write_header:type_name -> google.protobuf.Duration
	8,  // 60: Proxy.Get:input_type -> ConfigRequest
	12, // 61: Proxy.Put:input_type -> Config
	12, // 62: Proxy.Post:input_type -> Config
	9,  // 63: Proxy.Delete:input_type -> DeleteRequest
	12, // 64: Proxy.Get:output_type -> Config
	11, // 65: Proxy.Put:output_type -> Response
	11, // 66: Proxy.Post:output_type -> Response
	11, // 67: Proxy.Delete:output_type -> Response
...
func file_tcp_proto_init() {
	...
	file_tcp_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*Response_Ok)(nil),
		(*Response_Error)(nil),
	}
	...
	file_tcp_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*RequestMatch_Sni)(nil),
		(*RequestMatch_Host)(nil),
		(*RequestMatch_Path)(nil),
		(*RequestMatch_Fixed)(nil),
	}
	file_tcp_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*Rule_All)(nil),
		(*Rule_Any)(nil),
		(*Rule_Not)(nil),
		(*Rule_Tcp)(nil),
	...
	file_tcp_proto_msgTypes[34].OneofWrappers = []interface{}{
