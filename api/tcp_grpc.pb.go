...
type StorageClient interface {
	Set(ctx context.Context, in *Store_SetRequest, opts ...grpc.CallOption) (*Store_SetRequest, error)
	Get(ctx context.Context, in *Store_GetRequest, opts ...grpc.CallOption) (*Store_GetResponse, error)
}
...
func (c *storageClient) Set(ctx context.Context, in *Store_SetRequest, opts ...grpc.CallOption) (*Store_SetRequest, error) {
	out := new(Store_SetRequest)
...
func (c *storageClient) Get(ctx context.Context, in *Store_GetRequest, opts ...grpc.CallOption) (*Store_GetResponse, error) {
	out := new(Store_GetResponse)
...
type StorageServer interface {
	Set(context.Context, *Store_SetRequest) (*Store_SetRequest, error)
	Get(context.Context, *Store_GetRequest) (*Store_GetResponse, error)
...
func (UnimplementedStorageServer) Set(context.Context, *Store_SetRequest) (*Store_SetRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Set not implemented")
}
func (UnimplementedStorageServer) Get(context.Context, *Store_GetRequest) (*Store_GetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Get not implemented")
}
...
func _Storage_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServer).Set(ctx, req.(*Store_SetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Storage_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Store_GetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StorageServer).Get(ctx, req.(*Store_GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
