...
func ProxyGetBufferBytes(instance *host.Instance, bufferType int32, start int32, length int32, returnBufferData int32, returnBufferSize int32) int32 {
...
func ProxySetBufferBytes(instance *host.Instance, bufferType int32, start int32, length int32, dataPtr int32, dataSize int32) int32 {
	buf := GetBuffer(instance, BufferType(bufferType))
	if buf == nil {
		return WasmResultNotFound.Int32()
	}
