...
import (
	...
	"github.com/gernest/tt/wasm/host"
)
...
func (d *DefaultImportsHandler) GetVmConfig() *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetPluginConfig() *host.IoBuffer { return nil }
...
func (d *DefaultImportsHandler) GetDownStreamData() *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetUpstreamData() *host.IoBuffer { return nil }
...
func (d *DefaultImportsHandler) GetHttpRequestHeader() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) GetHttpRequestBody() *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetHttpRequestTrailer() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) GetHttpResponseHeader() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) GetHttpResponseBody() *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetHttpResponseTrailer() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) GetHttpCallResponseHeaders() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) GetHttpCallResponseBody() *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetHttpCallResponseTrailer() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) HttpCall(url string, headers *host.HeaderMap, body *host.IoBuffer, trailer *host.HeaderMap, timeoutMilliseconds int32) (int32, WasmResult) {
...
func (d *DefaultImportsHandler) GetGrpcReceiveInitialMetaData() *host.HeaderMap { return nil }

func (d *DefaultImportsHandler) GetGrpcReceiveBuffer() *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetGrpcReceiveTrailerMetaData() *host.HeaderMap { return nil }
...
func (d *DefaultImportsHandler) GetFuncCallData() *host.IoBuffer { return nil }
...
func (d *DefaultImportsHandler) GetCustomBuffer(bufferType BufferType) *host.IoBuffer { return nil }

func (d *DefaultImportsHandler) GetCustomHeader(mapType MapType) *host.HeaderMap { return nil }
