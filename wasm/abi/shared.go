...
func ProxyGetProperty(instance *host.Instance, keyPtr int32, keySize int32, returnValueData int32, returnValueSize int32) int32 {
...
func ProxySetProperty(instance *host.Instance, keyPtr int32, keySize int32, valuePtr int32, valueSize int32) int32 {
	key, err := instance.GetMemory(uint64(keyPtr), uint64(keySize))
	if err != nil {
		return WasmResultInvalidMemoryAccess.Int32()
	}
...
func ProxyRegisterSharedQueue(instance *host.Instance, queueNamePtr int32, queueNameSize int32, tokenPtr int32) int32 {
...
func ProxyResolveSharedQueue(instance *host.Instance, queueNamePtr int32, queueNameSize int32, tokenPtr int32) int32 {
	queueName, err := instance.GetMemory(uint64(queueNamePtr), uint64(queueNameSize))
	if err != nil {
		return WasmResultInvalidMemoryAccess.Int32()
	}
...
func ProxyGetSharedData(instance *host.Instance, keyPtr int32, keySize int32, valuePtr int32, valueSizePtr int32, casPtr int32) int32 {
	key, err := instance.GetMemory(uint64(keyPtr), uint64(keySize))
	if err != nil {
		return WasmResultInvalidMemoryAccess.Int32()
	}
...
func ProxySetSharedData(instance *host.Instance, keyPtr int32, keySize int32, valuePtr int32, valueSize int32, cas int32) int32 {
	key, err := instance.GetMemory(uint64(keyPtr), uint64(keySize))
	if err != nil {
		return WasmResultInvalidMemoryAccess.Int32()
	}
