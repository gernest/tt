...
func copyIntoInstance(instance *host.Instance, value string, retPtr int32, retSize int32) WasmResult {
...
func getContextHandler(instance *host.Instance) ContextHandler {
...
func getImportHandler(instance *host.Instance) ImportsHandler {
