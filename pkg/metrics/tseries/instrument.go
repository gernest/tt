...
func InstrumentHandlerDuration(next http.Handler) http.HandlerFunc {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		next.ServeHTTP(d, r)
		m.RecordRequest(r)
		m.Response.Code = d.Status()
		m.Response.Duration = time.Since(now)

		// try to expose a bunch of metrics
